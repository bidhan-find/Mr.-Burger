...
var menuBtn = doc.querySelector(".nav-menu-btn");
var navigation = doc.querySelector(".nav__menu");
var closeBtn = doc.querySelectorAll(".nav-close");
...
function shippingCostCounter(price) {
  var setShippingCost = function setShippingCost(num) {
    ...
    totalPrice.innerText = price + (cart === null || cart === void 0 ? void 0 : cart.shippingCost);
...
function loadData() {
  ...
  cartData.orderCart = (_localStorage2 = localStorage) === null || _localStorage2 === void 0 ? void 0 : _localStorage2.getItem("cart");
  shippingCostCounter(cart === null || cart === void 0 ? void 0 : cart.totalPrice); // check if order btn exist
    ...
    cartItemsArray.forEach(function (product) {
      ...
      cartDOMItems.forEach(function (individualItem) {
        if (individualItem.querySelector("#burgerId").value === product.item.id) {
          ...
          decreaseItem(individualItem, product); // Removing Element
...
var alertMsg = doc.querySelector("#OPSuccessAlert");
alertMsg === null || alertMsg === void 0 ? void 0 : alertMsg.classList.add("d-none");
...
__webpack_require__(/*! D:\B__Development\nodejs\mr.-burger\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\B__Development\nodejs\mr.-burger\resources\scss\app.scss */"./resources/scss/app.scss");
